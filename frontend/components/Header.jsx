  ...
  return (
    ...
    <nav className="nav" style={{ gap: 16 }}>
      ...
      <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
        <select value={city} onChange={onCityChange} style={{ height: 36, padding: "0 8px", borderRadius: 6, border: "none", background: "#fff", appearance: "auto", textAlign: "center", textAlignLast: "center" }}>
          {cities.map((c) => {
            const uaMap = {
              Kyiv: "м. Київ",
              Lviv: "м. Львів",
      ...
      <div className="nav-links" style={{ alignItems: "center", gap: 12 }}>
        <span aria-hidden style={{ display: "inline-flex", alignItems: "center", justifyContent: "center", width: 28, height: 28 }}>
        ...
        <select defaultValue="Українська" style={{ height: 36, padding: "0 8px", borderRadius: 6, border: "none", background: "#fff", appearance: "auto" }}>
